...
const Header = () => {
	...
	return (
		<header
			className={`${styles.header} text-color_three bg-color_two w-full h-12 flex justify-between items-center px-9 TABLET1024:px-5 MOBILE768:flex-wrap MOBILE768:h-24 MOBILE768:pt-3 MOBILE768:px-4`}
		>
			<h1
			...
			>
				...
				<input
					type='text'
					className={`${styles.input} bg-color_ten rounded-3xl w-80 h-7 text-color_three pl-7 pt-1 outline-none MOBILE768:w-52 MOBILE768:w-40`}
				/>
				<button
			...
			>
				<Link
					to='/about'
					className={`${styles.link__about} text-color_three MOBILE375:mr-12 hover:text-color_eight MOBILE430:mr-24 MOBILE768:mr-72 MOBILE624:mr-32`}
				>
					About us
				</Link>
				<div
